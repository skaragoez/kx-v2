 ...
 */
Behaviours.add('navigation', function ($context) {
  var $siteNavigation = $context.querySelector('#site-navigation');
  ...
  try {
    for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
      var _$link = _step2.value;
      _$link.addEventListener('touchstart', toggleFocus, false);
    }
